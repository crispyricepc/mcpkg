...
readme_url = f'https://raw.githubusercontent.com/CRISPYrice/mcpkg/{release_tag}/README.md'
license_url = f'https://raw.githubusercontent.com/CRISPYrice/mcpkg/{release_tag}/LICENSE.md'
...
with open('./pkgbuild/mcpkg-bin/PKGBUILD', 'w') as pkgbuild:
    ...
    source_url_prefix = f'https://github.com/CRISPYrice/mcpkg/releases/download/{release_tag}'
